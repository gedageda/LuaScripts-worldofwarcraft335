--[[作者信息：
	Auto Learn Spells  （升级自动学习技能）
	原作者：247321453@qq.com
	日期：2014
...
2025-12-16 by long
优化等级检查逻辑：
对于普通职业（非死亡骑士）：从2级开始学习和检查
对于死亡骑士职业：从56级开始学习和检查
登录检查时，只有当前等级≥起始等级时才执行检查
添加智能起始等级判断：

lua
-- 在 OnLevelChange 中
local startLevel = math.max(oldLevel + 1, 2)
if playerClass == CLASS_DEATH_KNIGHT then
    startLevel = math.max(startLevel, 56)
end
...
使用建议：
对于测试环境：开启DEBUG_MODE = true可以查看详细的学习日志
对于生产环境：保持ENABLE_CACHE = true以获得最佳性能
如果需要调整起始等级：可以修改配置区域的LOGIN_CHECK和逻辑中的起始等级判断
这样的优化确保了：
从2级开始按等级逐步学习技能
死亡骑士从56级开始学习
代码执行效率高，适合服务器长期运行
...
print(">>auto_learn_spell.lua has been loaded.")

----------------------------------------------------
-- 配置区域
local LOGIN_CHECK = true -- 是否在登录时检查技能
local ENABLE_CACHE = true -- 启用技能学习缓存（推荐开启）
local DEBUG_MODE = false -- 调试模式，输出详细日志
...
-- 缓存表，避免重复检查已学技能
local SpellCache = {}
local ClassSpellMaps = {} -- 预处理的职业技能映射
...
local SKILL={
	[CLASS_WARRIOR]={--战士
		...
		[8]={1715,284},
		[9]={71},
		[10]={199,266,5011,200,264,15590,227,6546,2687,3127,355},
		[12]={7384,5242,72},
		[14]={1160,6572,1161},
		[16]={285,694,2565},
		[18]={8198,676},
		[20]={674,6547,20230,845,12678},
		[22]={6192,5246},
		...
		[68]={25208,25231,469},
		[69]={2048,25242},
		[70]={30356,30324,25203,25236,3411,30357},
		[71]={46845,64382},
		[72]={47449,47519},
		[73]={47501,47470},
		[74]={47439,47474},
	...
	[CLASS_PALADIN]={--圣骑士
		[4]={465,19740,20271,33388},
		[6]={639,498},
		[8]={3127,1152,853},
		[10]={199,200,196,197,633,10290,1022},
		[12]={19834,53408},
		[13]={7328},
		[14]={19742,647,31789},
		[16]={62124,25780,7294},
		[18]={1044},
		[20]={34769,26573,879,19750,5502,20217,643, 13819},
		...
		[38]={3472,20166,10278},
		[40]={750,20922,1032,5589,19895,  23214,34767},
		[42]={4987,19941,19837},
		...
		[54]={10308,19854,25894,10329,1030},
		[56]={19898,10301},
		[58]={19943},
	...
	[CLASS_HUNTER]={--猎人
		...
		[6]={3044,1130},
		[8]={3127,5116,14260},
		[10]={202,5011,200,266,2567,15590,227,13165,13549,19883,   883,982,1515,1528,2641,6991,5149},
		...
		[22]={14323,3043},
		[24]={1462,14262,19885},
		[26]={3045,19880,14302,13551,3035},
		...
		[38]={14320},
		[40]={8737,13159,14324,1510,14310,14264,19882},
		[42]={14289,13553},
	...
	[CLASS_WARLOCK]={--术士
		...
		[6]={1454,695},
		[8]={980,5782,   697},
		[10]={201,1120,6201,696,707},
		[12]={1108,755,705},
		[14]={6222,689},
		[16]={1455,5697},
		[18]={1014,693,5676},
		[20]={5784,706,3698,698,1094,5740,1088,5784,  712,},
		...
		[60]={25309,25311,603,11722,20757,17728,11735,11695,28610,11668,11661},
		[61]={27224},
	...
	[CLASS_PRIEST]={--牧师
		[4]={1243,2052,589,33388},
		[6]={17,591},
		[8]={139,586},
		[10]={1180,2053,2006,8092,594},
		[12]={588,1244,592},
	...
	[CLASS_SHAMAN]={--萨满
		...
		[10]={1180,196,197,15590,199,8050,8024,8075},
		...
		[40]={8737,66843,930,10447,8134,8235,1064,51988,6377,8005},
		[41]={52134},
		[42]={11314,10537},
		...
		[70]={2825,25442,25547,25457,25472,51993,25396},
	...
	[CLASS_ROGUE]={--盗贼
		...
		[6]={1776,1757},
		[8]={6760,5277},
		[10]={196,264,15590,198,266,201,5011,5171,2983,6770},
		[12]={3127,2589,1766},
		[14]={8647,703,1758},
		[16]={6761,1966,1804},
		[18]={8676},
	...
	[CLASS_DEATH_KNIGHT]={--死亡骑士
		[56]={198,199,50842,49998,46584,52382,33388},
		[57]={53342,54447,48263,47528},
		[58]={48721,45524},
		[59]={49926,47476},
		...
		[64]={49927,45529},
		[65]={57330,56222,57330,49918},
		[66]={49939,48743},
		[67]={49903,51423,56815,49936},
		[68]={48707,49893},
		[69]={49928},
		[70]={53344,45463,49919,48265},
		[72]={62158,70164,49940,61999},
...
--[[
优化：预处理技能表，创建快速索引
将技能表转换为 {职业 = {技能ID = 等级}} 的映射
方便快速查找某个技能应该在多少级学习
]]
local function PreprocessSpellTables()
    if next(ClassSpellMaps) ~= nil then return end -- 已预处理
    
    for classId, levels in pairs(SKILL) do
        ClassSpellMaps[classId] = {}
        for level, spellList in pairs(levels) do
            for _, spellId in ipairs(spellList) do
                ClassSpellMaps[classId][spellId] = level
            end
        end
    end
    
    if DEBUG_MODE then
        print("AutoLearnSpell: 技能表预处理完成")
    end
end

-- 批量学习技能，减少API调用次数
local function BatchLearnSpells(player, spellIds)
    ...
    for _, spellId in ipairs(spellIds) do
        -- 检查缓存（如果启用）
        local cacheKey = playerGUID .. "_" .. spellId
        if ENABLE_CACHE and SpellCache[cacheKey] then
            goto continue
        end
        ...
        if not player:HasSpell(spellId) then
            ...
            if ENABLE_CACHE then
                SpellCache[cacheKey] = true
            end
            
            if DEBUG_MODE then
                print(string.format("AutoLearnSpell: %s 学习了技能 %d", playerName, spellId))
            end
...
local function LearnSpell(player, fromLevel, toLevel)
    ...
    if not classSpells then
        if DEBUG_MODE then
            print(string.format("AutoLearnSpell: 职业 %d 的技能表不存在", playerClass))
        end
        return 0
    end
    ...
    for level = fromLevel, toLevel do
        ...
        if levelSpells then
            for _, spellId in ipairs(levelSpells) do
                allSpells[#allSpells + 1] = spellId
            end
        end
    end
    
    -- 批量学习
    return BatchLearnSpells(player, allSpells)
end
...
local function OnLogin(event, player)
    ...
    -- 清理旧的缓存
    for k, _ in pairs(SpellCache) do
        if k:find(playerGUID .. "_") then
            SpellCache[k] = nil
        end
    end
    ...
    local startLevel
    if playerClass == CLASS_DEATH_KNIGHT then
        startLevel = 56 -- 死亡骑士起始等级高
    else
        startLevel = 2 -- 其他职业从2级开始
    end
    
    -- 只有当前等级大于等于起始等级时才检查
    if currentLevel >= startLevel then
        local learned = LearnSpell(player, startLevel, currentLevel)
        
        if DEBUG_MODE and learned > 0 then
            print(string.format("AutoLearnSpell: %s 登录时学习了 %d 个技能", 
                  player:GetName(), learned))
        elseif DEBUG_MODE then
            print(string.format("AutoLearnSpell: %s 登录检查，无需学习新技能", 
                  player:GetName()))
        end
    end
end
...
local function OnLevelChange(event, player, oldLevel)
    ...
    local learned = LearnSpell(player, startLevel, newLevel)
    
    if DEBUG_MODE and learned > 0 then
        print(string.format("AutoLearnSpell: %s 从 %d 级升到 %d 级，学习了 %d 个技能", 
              player:GetName(), oldLevel, newLevel, learned))
    end
end

-- 玩家登出时清理缓存
local function OnLogout(event, player)
    if not ENABLE_CACHE then return end
